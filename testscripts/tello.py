    ...
    def command_response_receiver(self):
        ...
        while self.is_running:
            try: 
                ...
                self.response, client_address = self.command_socket.recvfrom(1024)  # buffer size is 1024 bytes
                print '1 ' + str(client_address) +  str(self.response)
                timeout_count = 0
