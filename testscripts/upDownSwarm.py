  ...
  while True:
    ...
    try:
      for i in range(tello_number):
        ...
        print("Received message: from tello " + str(i) + " : " + response.decode(encoding='utf-8'))
    except Exception as e:
...
# Got to top/bottom
sendToOne(1, "down " + str(d/2))
sendToOne(2, "up " + str(d/2))
time.sleep(3)

# Bounce up and down twice
for i in range(2):
  sendToOne(1, "up " + str(d))
  sendToOne(2, "down " + str(d))
  time.sleep(3)
  sendAll("speed 80", 1)
  sendToOne(1, "ccw " + str(360))
  sendToOne(2, "cw " + str(360))
  time.sleep(8)

  sendAll("speed 50", 1)
  
  sendToOne(1, "down " + str(d))
  sendToOne(2, "up " + str(d))
  time.sleep(10)
  sendAll("speed 80", 1)
  sendToOne(1, "cw " + str(360))
  sendToOne(2, "ccw " + str(360))
  time.sleep(8)

  sendAll("speed 50", 1)

# Even out
sendToOne(1, "up " + str(d/2))
sendToOne(2, "down " + str(d/2))
time.sleep(2)
